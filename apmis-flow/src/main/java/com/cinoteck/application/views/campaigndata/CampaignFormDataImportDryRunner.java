 ...
 */
public class CampaignFormDataImportDryRunner extends DataImporter {

	private static final Logger LOGGER = LoggerFactory.getLogger(CampaignFormDataImportDryRunner.class);
	...
	public CampaignFormDataImportDryRunner(File inputFile, boolean hasEntityClassRow, UserDto currentUser,
	...
	protected ImportLineResult importDataFromCsvLine(String[] values, String[] entityClasses, String[] entityProperties,
		...
		CampaignFormDataDryRunDto campaignFormData = CampaignFormDataDryRunDto.build();
...
//										.formDate(campaignFormData.getFormDate()));
	...
	private CampaignFormDataDryRunDto insertImportRowIntoData(CampaignFormDataDryRunDto campaignFormData,
		...
		ImportLineResultDto<CampaignFormDataDryRunDto> constraintErrors = validateConstraints(campaignFormData);
