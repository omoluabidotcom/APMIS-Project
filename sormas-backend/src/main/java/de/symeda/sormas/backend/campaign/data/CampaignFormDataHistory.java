...
@Entity
@Audited
@Table(name = "campaignformdata_history")
public class CampaignFormDataHistory extends AbstractDomainObject{
	  @Id
	    ...
	    @ManyToOne
	    @JoinColumn(name = "campaignformdata_id", referencedColumnName = "id")
	    private CampaignFormData campaignFormData;
