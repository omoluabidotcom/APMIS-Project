...
public enum UserRight {
	...
	USER_EDIT(
			...
			COMMUNITY_INFORMANT
			//			NATIONAL_USER,
			//			SURVEILLANCE_SUPERVISOR, AREA_SURVEILLANCE_SUPERVISOR, Admin Regional Coordinator
			//          ADMIN_SUPERVISOR, AREA_ADMIN_SUPERVISOR,
			//			CASE_SUPERVISOR,
			//			CONTACT_SUPERVISOR,
			//			LAB_USER,
	...
	CONFIGURATION_ACCESS(
			...
			NATIONAL_USER,
			POE_NATIONAL_USER,
			AREA_SURVEILLANCE_SUPERVISOR,
			ADMIN_SUPERVISOR, AREA_ADMIN_SUPERVISOR,
			POE_SUPERVISOR, COMMUNITY_INFORMANT
	),
...
//			COMMUNITY_INFORMANT
	...
	INFRASTRUCTURE_PERFORM_BULK_OPERATIONS(
			ADMIN,
//			,
//			AREA_ADMIN_SUPERVISOR, 
//			ADMIN_SUPERVISOR,
...
//			NATIONAL_USER
	...
	AGGREGATE_REPORT_EDIT(ADMIN, NATIONAL_USER, NATIONAL_CLINICIAN, NATIONAL_OBSERVER, POE_NATIONAL_USER,
			STATE_OBSERVER, AREA_STATE_OBSERVER, DISTRICT_OBSERVER, SURVEILLANCE_SUPERVISOR, AREA_SURVEILLANCE_SUPERVISOR,
			ADMIN_SUPERVISOR, AREA_ADMIN_SUPERVISOR, CASE_SUPERVISOR, CONTACT_SUPERVISOR,
	...
	CAMPAIGN_VIEW(
      		...
      		NATIONAL_USER,
      		SURVEILLANCE_SUPERVISOR, AREA_SURVEILLANCE_SUPERVISOR,
      		AREA_SURVEILLANCE_SUPERVISOR, AREA_SURVEILLANCE_SUPERVISOR,
			ADMIN_SUPERVISOR, AREA_ADMIN_SUPERVISOR,
     		SURVEILLANCE_OFFICER,
      		CASE_SUPERVISOR,
      		CASE_OFFICER, 
	...
	CAMPAIGN_FORM_DATA_ARCHIVE(
			ADMIN, NATIONAL_USER, COMMUNITY_INFORMANT
	),
	CAMPAIGN_FORM_DATA_DELETE(
			ADMIN, NATIONAL_USER, COMMUNITY_INFORMANT, EDITOR_USER
	)
	, 
	REASSIGN_CAMPAIGN_FORM_DATA_CLUSTER(
			ADMIN, EDITOR_USER
	)
	,
	CAMPAIGN_FORM_DATA_IMPORT(
			ADMIN, COMMUNITY_INFORMANT, SURVEILLANCE_SUPERVISOR
	)
	,
